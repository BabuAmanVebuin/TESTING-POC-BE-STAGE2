...
import { EBITDAJson } from "../../../domain/models/dpm/KPI003/Index.js"
import { env } from "../../../infrastructure/env/dpm/index.js"

// Function to generate EBITDA JSON
export const generateEBITDAResponseUseCase = async (
  plantCode: string,
  ...
  // Fetch EBITDA estimates asynchronously using Promise.all
  const [
    plannedRows,
    ...
    dailyEstimatesArray,
    grossmarginCurrentFiscalYearEstimates,
    ...
    // Fetch annual EBITDA estimates
    kpi003Repository.getEBITDAEstimates(
      plantCode,
      unitCode,
      "annual",
    ...
    // Fetch monthly EBITDA estimates
    kpi003Repository.getEBITDAEstimates(
      plantCode,
      unitCode,
      "monthly",
    ...
    // Fetch GrossMargin estimates for the current fiscal year
    kpi003Repository.getGrossMarginEstimates(
      plantCode,
      unitCode,
      "annual",
  ...
  // Generate the EBITDA JSON object
  const returnJson: EBITDAJson = {
    PlantCode: plantCode,
    UnitCode: unitCode,
    EBITDA: generateKpi003MeasureSectionUseCase({
      ...
      unscaledCurrentYear: {
        ...
        planned:
          (grossmarginCurrentFiscalYearEstimates[0]?.planned || 0) - (opexCurrentFiscalYearEstimates[0]?.planned || 0),
      },
