...
const GET_PATH = "/ebitda/forecast/summary"
...
describe("eitda forecast summary", function () {
  this.timeout(10000)
  ...
  it("get eitda forecast summary: snowflake only", async () => {
  ...
  it("get eitda forecast summary: MySQL Data", async () => {
