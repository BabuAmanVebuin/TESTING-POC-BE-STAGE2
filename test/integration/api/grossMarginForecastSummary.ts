...
import { insertFuelPriceForecastData, insertGenerationOutputForecastData } from "./grossMarginForecastSummaryHelper.js"

const app = express()
app.use(express.json())
app.use("/", createRouter())

const GET_PATH = "/grossmargin/forecast/summary"
...
describe("gross margin forecast summary", function () {
  this.timeout(10000)
  ...
  it("get gross margin forecast summary: snowflake only", async () => {
